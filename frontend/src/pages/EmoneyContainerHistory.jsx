...
export default function EmoneyContainerHistory(){
  ...
  return (
    <div style={{padding:24, fontFamily:'sans-serif'}}>
      ...
      <div style={{margin:'12px 0'}}>Total Expense: <b>{fmt(data.sum_expense)}</b> · Total Topup terkait: <b>{fmt(data.sum_topup)}</b></div>
        ...
        <table style={{width:'100%', borderCollapse:'collapse'}}>
          ...
          <tbody>
            {data.data.length ? data.data.map((t) => (
              ...
              <tr><td style={td} colSpan={5}>Belum ada transaksi terkait</td></tr>
            )}
          </tbody>
        </table>
      </div>
